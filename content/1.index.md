---
title: 'Fedishare - フェディバース向けシェアボタンをまとめよう'
...
```html
<script src="https://fedishare-api.ajr-news.com/api/v1/script"></script>
```

以下のように表示されます。

<FedisharePreview></FedisharePreview>
...
```html
<script data-color="dark" data-window="popup" src="https://fedishare-api.ajr-news.com/api/v1/script"></script>
```
...
```http
GET https://fedishare-api.ajr-news.com/api/v1/instance/<YOUR_DOMAIN>
```

...
また、設置に便利なバナー画像も用意しました。是非お使いください。

![Fediverseに共有](/badges/share-to-fediverse_v1.svg){style='height: 1.5em; width: auto;'}

```html
<img src="https://fedibuzzer.ajr-news.com/badges/share-to-fediverse_v1.svg" style="display:inline-block;height:24px;width:auto;" />
```
